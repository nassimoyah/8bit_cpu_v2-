...
#
# Script generated by Vivado on Sun Mar 30 18:54:49 +0200 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : my_cpu_design.sh
...
#
# Usage        : my_cpu_design.sh
#                my_cpu_design.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                my_cpu_design.sh [-reset_run]
#                my_cpu_design.sh [-reset_log]
#                my_cpu_design.sh [-help]
#
...
# script info
echo -e "my_cpu_design.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./my_cpu_design.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L secureip -L xpm --snapshot my_cpu_design xil_defaultlib.my_cpu_design -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim my_cpu_design -key {Behavioral:sim_1:Functional:my_cpu_design} -tclbatch cmd.tcl -protoinst "protoinst_files/my_cpu_design.protoinst" -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb my_cpu_design.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./my_cpu_design.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: my_cpu_design.sh [-help]\n\
Usage: my_cpu_design.sh [-step]\n\
Usage: my_cpu_design.sh [-lib_map_path]\n\
Usage: my_cpu_design.sh [-reset_run]\n\
Usage: my_cpu_design.sh [-reset_log]\n\
Usage: my_cpu_design.sh [-keep_index]\n\
Usage: my_cpu_design.sh [-noclean_files]\n\n\
