...
entity my_cpu_design is
  ...
  attribute CORE_GENERATION_INFO of my_cpu_design : entity is "my_cpu_design,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=my_cpu_design,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=8,numReposBlks=8,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=8,numPkgbdBlks=0,bdsource=USER,synth_mode=Hierarchical}";
...
architecture STRUCTURE of my_cpu_design is
  ...
  component my_cpu_design_Port_Or_1_0 is
  port (
    IN1 : in STD_LOGIC;
    IN2 : in STD_LOGIC;
    C : out STD_LOGIC
  );
  end component my_cpu_design_Port_Or_1_0;
  ...
  signal ALU_control_unit_jump3_enable : STD_LOGIC;
  signal ALU_control_unit_store_enable : STD_LOGIC;
  signal \^alu_output\ : STD_LOGIC_VECTOR ( 8 downto 0 );
  signal Port_Or_1_C : STD_LOGIC;
...
ALU_control_unit: component my_cpu_design_ALU_0_0
     port map (
      ...
      Z => \^zero_flag_0\,
      jump3_enable => ALU_control_unit_jump3_enable,
      jump_to_addr_enable => ALU_0_jump_enable,
      ...
      skip1 => ALU_0_jump1,
      store_enable => ALU_control_unit_store_enable
    );
...
Port_Or_1: component my_cpu_design_Port_Or_1_0
     port map (
      C => Port_Or_1_C,
      IN1 => ALU_control_unit_store_enable,
      IN2 => ALU_control_unit_jump3_enable
    );
Program_memory: component my_cpu_design_memoire_programe_0_0
     port map (
      ...
      op(7 downto 0) => \^opcode\(7 downto 0),
      reg_data_en => ALU_control_unit_store_enable,
